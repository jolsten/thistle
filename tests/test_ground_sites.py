...
class TestVisibilityCircle:
    ...
    def test_output_shape(self):
        ...
        lats, lons = visibility_circle(
            0.0, 0.0, sat_alt=400_000, min_el=10.0, n_points=72
        )
    ...
    def test_symmetry_equator(self):
        ...
        lats, lons = visibility_circle(
            0.0, 0.0, sat_alt=400_000, min_el=5.0, n_points=360
        )
    ...
    def test_ground_site_altitude(self):
        ...
        lats_mtn, _ = visibility_circle(
            0.0, 0.0, sat_alt=400_000, min_el=10.0, alt=5000.0
        )
    ...
    def test_n_points_one(self):
        ...
        lats, lons = visibility_circle(
            0.0, 0.0, sat_alt=400_000, min_el=10.0, n_points=1
        )
        assert lats.shape == (1,)
        assert lons.shape == (1,)
